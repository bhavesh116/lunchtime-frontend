...
import { updateOrganizationProfileInitiate, removeOrgProfileToast } from '../../../../redux/actions/OrganizationActions/orgProfile'
...
const ProfileEdit = (props) => {
    ...
    const fields = ['Org name', 'Email']

    useFocusEffect(
      React.useCallback(() => {
        let upStat = cloneDeep(state.fields)
        upStat['Org name'] = params.orgName
    ...
    const updateProfile = () => {
      ...
      if(required.length === 0) {
        let obj = {}
        obj.orgName = state.fields['Org name']
        obj.email = state.fields.Email
        obj.avatarUrl = state.fields.selectedAvatar
        dispatch(updateOrganizationProfileInitiate(obj))
      }
    }
    ...
    return (
        <MainWrapper>
          <EditProfileWrap>
            ...
            <View>
            <StyledText onPress={() => navigate('Org Password')}size={14} color="#23395d">
                Change password
            </StyledText>
            </View>
            </Header>
